...
(function() {
    ...
    var data = {
        "resource": {
            ...
            "macros": [{
                ...
                "vtp_dataLayerVersion": 2,
                "vtp_setDefaultValue": false,
                "vtp_name": "ecommerce.items.price"
            }, {
                "function": "__v",
                "vtp_dataLayerVersion": 2,
                "vtp_setDefaultValue": false,
                ...
                "vtp_dataLayerVersion": 2,
                "vtp_setDefaultValue": false,
                "vtp_name": "enhanced_conversion_data"
            }, {
                "function": "__v",
                "vtp_dataLayerVersion": 2,
                "vtp_setDefaultValue": false,
            ...
            "tags": [{
                ...
                "vtp_measurementIdOverride": "G-R5ERD16JT7",
                ...
                "vtp_sendEcommerceData": false,
                "vtp_enhancedUserId": false,
                "vtp_eventName": "email_address_click",
                "vtp_measurementIdOverride": "G-R5ERD16JT7",
                "vtp_enableUserProperties": true,
                "vtp_enableMoreSettingsOption": true,
                "vtp_enableEuid": true,
                ...
                "vtp_sendEcommerceData": false,
                "vtp_enhancedUserId": false,
                "vtp_eventName": "phone_number_click",
                "vtp_measurementIdOverride": "G-R5ERD16JT7",
                "vtp_enableUserProperties": true,
                "vtp_enableMoreSettingsOption": true,
                "vtp_enableEuid": true,
                ...
                "vtp_uniqueTriggerId": "174769826_6",
                "tag_id": 68
            }, {
                "function": "__fsl",
                "vtp_waitForTags": "",
                "vtp_checkValidation": "",
                "vtp_waitForTagsTimeout": "2000",
                "vtp_uniqueTriggerId": "174769826_9",
                "tag_id": 69
            }, {
                "function": "__lcl",
                "vtp_waitForTags": false,
                "vtp_checkValidation": false,
                "vtp_waitForTagsTimeout": "2000",
                "vtp_uniqueTriggerId": "174769826_13",
                "tag_id": 70
            }, {
                "function": "__evl",
                ...
                "vtp_uniqueTriggerId": "174769826_33",
                "tag_id": 71
            }, {
                "function": "__evl",
                "vtp_useOnScreenDuration": false,
                ...
                "vtp_firingFrequency": "ONCE",
                "vtp_elementSelector": "div.wpforms-submit-container",
                "vtp_selectorType": "CSS",
                "vtp_onScreenRatio": "1",
                "vtp_uniqueTriggerId": "174769826_69",
                "tag_id": 72
            }],
            "predicates": [{
                "function": "_eq",
                ...
                "function": "_re",
                "arg0": ["macro", 0],
                "arg1": "view_item_list|select_item|remove_from_cart|view_cart|begin_checkout|add_payment_info|add_shipping_info"
            }, {
                "function": "_eq",
                "arg0": ["macro", 0],
                "arg1": "view_item"
    ...
    */
    ...
    mi.ke = Number("0") || 0;
    mi.Za = "dataLayer";
    mi.kn = "ChEI8NSvswYQj6aIvKWsk8SNARIlAKpGVNDuHrzMnx0ijhe3zJ3jg1Dx6em5LtuQfBFrUmYc/hI2ZxoCQdY\x3d";
    var oi = {
            __cl: 1,
            __ecl: 1,
            __ehl: 1,
    ...
    var Ej = {},
        ...
        Nf = {
            ctid: "GTM-KBG9V4XZ",
            canonicalContainerId: "174769826",
            Sj: "GTM-KBG9V4XZ",
            Tj: "GTM-KBG9V4XZ"
        };
    Ej.he = zb("");
    ...
    var us = function(a) {
            if (ss) {
                if (a >= 0 && a < ts.length && ts[a]) {
                    var b;
                    (b = ts[a]) == null || b.disconnect();
                    ts[a] = void 0
                }
        ...
        xs = function(a, b, c) {
            ...
            return G.setInterval(vs(a, b, c), 1E3)
        },
        vs = function(a, b, c) {
            function d(h, m) {
                var n = {
        ...
        ws = function(a, b, c) {
            ...
            for (var f = 0; f < ts.length; f++)
                if (!ts[f]) return ts[f] = d, f;
            return ts.push(d) - 1
        },
        ts = [],
        ss = !(!G.IntersectionObserver || !G.IntersectionObserverEntry);
    var zs = function(a, b, c) {
            ...
            if (a === H.body) b = "body";
                ...
                if (a.id) c = "#" + a.id;
                    ...
                    if (a.parentElement) {
                        ...
                        d = ys(a.parentElement) + ">:nth-child(" + e + ")"
                    } else d = "";
                    c = d
                }
                b = c
        ...
        Ls = function() {
            ...
            for (var c = b.querySelectorAll("*"),
                ...
                var e = c[d];
                if (!(Is.indexOf(e.tagName.toUpperCase()) >= 0) && e.children instanceof HTMLCollection) {
                    for (var f = !1, g = 0; g < e.childElementCount && g < 1E4; g++)
                        if (!(Js.indexOf(e.children[g].tagName.toUpperCase()) >= 0)) {
                            f = !0;
                            break
                        }(!f || U(21) && Ks.indexOf(e.tagName) !== -1) && a.push(e)
                }
            }
            return {
                elements: a,
    ...
    var Gs = /[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}/i,
        ...
        Ds = /support|noreply/i,
        Is = "SCRIPT STYLE IMG SVG PATH BR NOSCRIPT TEXTAREA".split(" "),
        Js = ["BR"],
        Os = {
            on: "1",
            Bn: "2",
    ...
    var ht = function(a) {
        ...
        it = function(a) {
            return a.tagName + ":" + a.isVisible + ":" + a.Z.length + ":" + Ns.test(a.Z)
        };
    var pt = Number('') || 5,
        qt = Number('') || 50,
        rt = ub();
    ...
    var DA = function(a, b, c) {
        ...
        CA = function(a) {
            ...
            return FA.indexOf(b) < 0 || b === "input" && GA.indexOf(a.type.toLowerCase()) >= 0 ? !1 : !0
        },
    ...
    function KB(a) {
        ...
        for (var g = [], h = 1; h < arguments.length; h++) g.push(J(arguments[h], this.H, 2));
        var m = (0, this.H.M)(e, d, g);
        b = ed(m, this.H, 2);
    ...
    function cC(a) {
        ...
        d.Kh !== void 0 && b.set("preferredEmailElement", dC(d.Kh));
    ...
    var iC = function(a) {
            if (hC)
                for (var b = 0; b < hC.length; b++) hC[b] === a && hC.splice(b, 1)
        },
        kC = function(a) {
            if (!hC) {
                var b = function() {
                    var c = H.body;
                    if (c)
                        if (jC)(new MutationObserver(function() {
                            for (var e = 0; e < hC.length; e++) I(hC[e])
                        })).observe(c, {
                            childList: !0,
                            subtree: !0
                        });
        ...
        jC = !!G.MutationObserver,
        hC;
    var lC = function(a) {
            a.has("PollingId") && (G.clearInterval(Number(a.get("PollingId"))), a.m("PollingId"))
        },
        nC = function(a, b, c, d) {
            function e() {
                if (!ps(a.target)) {
                    b.has("RecentOnScreen") || b.set("RecentOnScreen", "" + mC());
                    b.has("FirstOnScreen") || b.set("FirstOnScreen", "" + mC());
                    var g = 0;
                    b.has("TotalVisibleTime") && (g = Number(b.get("TotalVisibleTime")));
                    g += 100;
                    b.set("TotalVisibleTime", "" + g);
                    if (g >= c) {
                        var h = BA(a.target, "gtm.elementVisibility", [b.uid]),
                            m = rs(a.target);
                        h["gtm.visibleRatio"] = Math.round(m * 1E3) / 10;
                        h["gtm.visibleTime"] =
                            c;
    ...
    function pC(a, b) {
        var c = function(u) {
                var v = new oC(u.target, p);
                u.intersectionRatio >= n ? v.has("HasFired") || nC(u, v, m, q === "ONCE" ? function() {
                    ...
                    v.set("HasFired", "1");
                    lC(v)
                }) : (lC(v), q === "MANY_PER_ELEMENT" && v.has("HasFired") && (v.m("HasFired"), v.m("TotalVisibleTime")), v.m("RecentOnScreen"))
            },
            d = function() {
                var u = !1,
                    v = null;
                ...
                v || (v = [], u = r.length > 0);
                if (u) {
                    for (var y = 0; y < r.length; y++) lC(new oC(r[y], p));
                    r = [];
                    for (var x = 0; x < v.length; x++) r.push(v[x]);
                    t >= 0 && us(t);
                    r.length > 0 && (t = xs(c, r, [n]))
                }
            };
    ...
    var CC = function(a, b, c, d, e) {
            var f = wA("fsl", c ? "nv.mwt" : "mwt", 0),
                g;
            g = c ? wA("fsl", "nv.ids", []) : wA("fsl", "ids", []);
            if (!g.length) return !0;
            var h = BA(a, "gtm.formSubmit", g),
                m = a.action;
            m && m.tagName && (m = a.cloneNode(!1).action);
            P(121);
            if (m === "https://www.facebook.com/tr/") return P(122), !0;
            h["gtm.elementUrl"] = m;
        ...
        FC = function() {
            ...
            Ec(H, "click", function(c) {
                ...
                if (d && (d = Jc(d, ["button", "input"], 100)) && (d.type ==
                        "submit" || d.type == "image") && d.name && Gc(d, "value")) {
                    var e = EA(d);
                    e && a.store(e, d)
                }
            }, !1);
    ...
    function GC(a, b) {
        ...
        AA("fsl", "ids", h, []);
        e || AA("fsl", "nv.ids", h, []);
        wA("fsl", "init", !1) || (FC(), xA("fsl", "init", !0));
        return b
    }
    ...
    Z.securityGroups.detect_element_visibility_events = ["google"],
        function() {
            function a() {
                ...
                Z.__detect_element_visibility_events.D = "detect_element_visibility_events";
